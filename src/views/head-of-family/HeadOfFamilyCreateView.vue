                ...
                <section id="Nama-Kepala-Rumah" class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col gap-3 flex-1 shrink-0">
                        <Input
                            ...
                            type="text"
                            placeholder="Masukan nama kepala rumah"
                            :error-message="validationErrors.name || error?.name"
                ...
                <section id="NIK" class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col gap-3 flex-1 shrink-0">
                        <Input
                            ...
                            maxlength="16"
                            :error-message="
                                validationErrors.identity_number || error?.identity_number
                            "
                    ...
                    <div class="flex items-center gap-6 flex-1 shrink-0">
                        <label class="relative group peer w-full valid">
                            <Input
                                ...
                                :error-message="
                                    validationErrors.date_of_birth || error?.date_of_birth
                                "
