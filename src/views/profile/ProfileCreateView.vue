...
const generalError = computed(() => {
    ...
    if (error.value && typeof error.value === 'object') {
        return 'Profile desa gagal dibuat. Periksa kembali input yang bertanda error.';
    }
...
<template>
    <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col gap-2">
                <div class="flex gap-1 items-center leading-5 text-desa-secondary">
                    <router-link :to="{ name: 'profile' }" replace
                        ...
                        Desa</router-link>
                    <span>/</span>
                    <p class="last-of-type:text-desa-dark-green last-of-type:font-semibold capitalize ">Create Profile
                        Desa</p>
                </div>
        ...
        <div v-if="generalError" class="relative rounded-2xl border border-red-400 bg-red-100 px-4 py-3 text-red-700"
            role="alert">
            ...
            <div class="shrink-0 rounded-3xl p-6 bg-white flex flex-col gap-6 h-fit">
                <section id="Photos" class="flex justify-between">
                    ...
                    <div class="photo-input-container flex flex-col gap-6 flex-1">
                        <div class="photo-form group/parent flex items-center justify-between gap-6">
                            <div
                        ...
                        <div v-for="(image, index) in profile.images" :key="index"
                            class="photo-form flex items-center justify-between gap-6">
                            <div
                                class="Photo-Preview flex justify-center w-[120px] h-[100px] rounded-2xl overflow-hidden bg-desa-foreshadow shrink-0">
                ...
                <section id="Deskripsi" class="flex items-center justify-between">
                    <p class="font-medium leading-5 text-desa-secondary w-[calc(424/904*100%)]">Deskripsi Tentang Desa
                    </p>
                    <div class="flex flex-col gap-3 flex-1 shrink-0">
