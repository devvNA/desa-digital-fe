            ...
            <div class="flex flex-col gap-2">
                <div class="flex gap-1 items-center leading-5 text-desa-secondary">
                    <RouterLink :to="{ name: 'event' }"
                        ...
                        Desa</RouterLink>
                    <span>/</span>
                    <p class="last-of-type:text-desa-dark-green last-of-type:font-semibold capitalize ">Tambah Event
                        Desa</p>
                </div>
        ...
        <form @submit.prevent="handleSubmit" id="myForm" class="capitalize">
            <div class="shrink-0 rounded-3xl p-6 bg-white flex flex-col gap-6 h-fit">
                <section id="Thumbnail" class="flex items-center justify-between">
                    ...
                    <div class="flex-1 flex items-center justify-between">
                        <div
                            ...
                            <img :src="event.thumbnail_url || fallbackThumbnail" alt="image" class="size-full object-cover"
                                @error="onImageError" />
                        </div>
                        <div class="relative">
                ...
                <section id="Waktu" class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col gap-3 flex-1 shrink-0">
                        <div class="relative w-full">
                            ...
                            <Teleport to="body">
                                <div v-if="isTimeModalOpen" class="fixed inset-0 z-[1000] flex items-center justify-center">
                ...
                <div v-if="getFieldError('description')" class="flex justify-end">
                    <span class="w-full max-w-[480px] text-left text-desa-red text-xs">{{ getFieldError('description')
                        }}</span>
                </div>
