...
<template>
    <div class="flex flex-col gap-4">
        ...
        <div
            v-if="generalError"
            class="rounded-2xl border border-red-400 bg-red-100 px-4 py-3 text-red-700"
            role="alert"
        >
        ...
        <section id="List-pengajuan-Bansos" class="flex flex-col gap-[14px]">
                ...
                <div class="flex flex-col gap-3 w-[370px] shrink-0">
                    <label class="relative group peer w-full valid">
                        <input
                            ...
                            placeholder="Cari nama warga atau bantuan sosial"
            ...
            <CardList
                :socialAssistanceRecipients="socialAssistanceRecipients"
                :loading="loading"
