...
import { fallbackThumbnail, getThumbnail, handleImageError } from '@/helpers/socialAssistance'
...
const startDateInput = computed({
    get: () => normalizeDateInput(development.value.start_date),
    set: (value) => {
        development.value.start_date = value
    },
})

const dayInput = computed({
    get: () => development.value.days_needed ?? '',
    set: (value) => {
        development.value.days_needed = value
    },
})

const thumbnailPreview = computed(() => {
    return previewObjectUrl.value || getThumbnail(development.value.thumbnail)
})
...
function syncEndDate() {
    development.value.end_date = calculateEndDate(
        normalizeDateInput(development.value.start_date),
        development.value.days_needed,
    )
}
...
watch([() => development.value.start_date, () => development.value.days_needed], syncEndDate)
            ...
            <div class="shrink-0 rounded-3xl p-6 bg-white flex flex-col gap-6 h-fit">
                ...
                <section id="Thumbnail" class="flex items-center justify-between">
                    ...
                    <div class="flex-1 flex items-center justify-between">
                        ...
                        >
                            <img
                                :src="thumbnailPreview || fallbackThumbnail"
                                alt="image"
                ...
                <section id="Buttons" class="flex items-center justify-end gap-4">
                    <RouterLink
                        :to="{ name: 'manage-development', params: { id: development.id } }"
                    >
                        <div
