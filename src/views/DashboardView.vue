...
const socialAssistanceRecipients = computed(() => dashboardPayload.value?.social_assistance_recipients ?? [])
const eventParticipants = computed(() => dashboardPayload.value?.event_participants ?? [])
const developmentApplicants = computed(() => dashboardPayload.value?.development_applicants ?? [])
...
const developmentApplicantsCount = computed(() =>
    getNumber(headOfFamilySummary.value?.development_applicants_count, developmentApplicants.value.length),
)
...
<template>
    <div class="flex flex-col gap-[14px] pb-[14px]">
        <div class="flex items-start justify-between gap-4 mb-2">
            <div v-if="loading && hasDashboardData && user?.role === 'admin'"
                ...
                <div class="flex gap-[14px]">
                    <div class="flex flex-col gap-[14px] shrink-0 w-[calc(463/1000*100%)]">
                                ...
                                <div class="event py-4 rounded-2xl border border-desa-background flex flex-col gap-4"
                                    ...
                                    <div class="card px-4 flex items-center gap-3">
                                        <div
                                            ...
                                            <img :src="getThumbnail(data.event?.thumbnail)" alt="image"
                        ...
                        <section id="Pembangunan" class="flex flex-col gap-6 p-6 bg-white rounded-2xl">
                            ...
                            <div id="Recent-Applicants" class="flex flex-col gap-4">
                                ...
                                <div v-if="isDevelopmentApplicantsInitialLoading"
                                    class="applicant p-4 rounded-2xl border border-desa-background flex flex-col gap-4">
                                    Memuat data pembangunan...
                                </div>
                                <div v-else-if="developmentApplicants.length === 0"
                                    class="applicant p-4 rounded-2xl border border-desa-background flex flex-col gap-4">
                                    Belum ada lamaran pembangunan.
                                </div>
                                <div class="applicant p-4 rounded-2xl border border-desa-background flex flex-col gap-4"
                                    v-for="data in developmentApplicants" :key="data.id">
                                    <div class="flex items-center justify-between">
                                        <div
                                            class="flex items-center justify-center w-[100px] h-[80px] shrink-0 rounded-2xl overflow-hidden">
                                            <img :src="getThumbnail(data.development?.thumbnail)" alt="image"
                                                class="size-full shrink-0 object-cover"
                                                @error="handleImageError($event, fallbackThumbnail)" />
                                        </div>
                                        <div :class="getStatusConfig(data.status).className"
                                    ...
                                    <div class="flex flex-col gap-1">
                                        ...
                                        <div class="flex gap-1">
                                            ...
                                            <p class="font-semibold leading-5 text-desa-dark-green">{{
                                                data.development.person_in_charge }}</p>
                                        </div>
                                    </div>
                                    <hr class="border-desa-background" />
                                    ...
                                    <div id="Waktu-Pelaksanaan" class="flex items-center gap-[12px]">
                                        ...
                                        <div class="flex flex-col gap-1">
                                            <p class="font-semibold leading-5 text-desa-dark-green">{{
                                                data.development.days_needed }} Hari</p>
                    ...
                    <div class="flex flex-col gap-[14px] flex-1">
                        <section id="Anggota-Keluarga" class="flex flex-col gap-6 p-6 bg-white rounded-2xl">
                            <div class="flex items-center justify-between">
                                <div class="flex flex-col gap-[6px]">
                                    <strong class="font-semibold text-[32px] leading-[40px]">{{ familyMembersCount
                                        }}</strong>
                                    ...
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center gap-[12px]">
                                            <div
                                                ...
                                                <img :src="getProfilePicture(familyMember.profile_picture)"
                        ...
                        <section id="Pengajuan-Bantuan-Sosial" class="flex flex-col gap-6 p-6 bg-white rounded-2xl">
                            <div class="flex items-center justify-between">
                                <div class="flex flex-col gap-[6px]">
                                    <strong class="font-semibold text-[32px] leading-[40px]">{{
                                        socialAssistanceRecipientsCount }}
                                        Pengajuan</strong>
