        ...
        <section id="Statistics" class="grid grid-cols-2 flex-1 shrink-0 gap-[14px]">
          ...
          >
            ...
            <div class="flex flex-col gap-[6px]">
              <p class="font-semibold text-[32px] leading-10">{{ formatNumber(card.value) }}</p>
      ...
      <div id="Row-3" class="flex gap-[14px]">
        ...
        >
          ...
          <div class="relative">
            ...
            >
              <p class="font-semibold text-[32px] leading-10">{{ formatNumber(totalResidents) }}</p>
            ...
            <template v-for="(segment, index) in residentSegments" :key="segment.label">
              <div class="flex items-center justify-between">
                <div class="flex flex-col gap-1">
                  ...
                  <p class="font-medium text-sm text-desa-secondary">{{ segment.description }}</p>
                </div>
          ...
          >
            Detail segment penduduk akan tampil otomatis ketika API mengirimkan rincian kategori
            seperti pria, wanita, anak-anak, atau balita.
          </div>
        </section>
      </div>
    </template>
