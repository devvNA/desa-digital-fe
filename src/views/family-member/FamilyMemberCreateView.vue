...
const fallbackProfilePicture = new URL('@/assets/images/photos/kk-preview.png', import.meta.url).href
            ...
            <div class="shrink-0 rounded-3xl p-6 bg-white flex flex-col gap-6 h-fit">
                ...
                <section id="Nomor-Induk-Kependudukan" class="flex items-center justify-between">
                    <h2 class="font-medium leading-5 text-desa-secondary w-[calc(424/904*100%)]">Nomor Induk
                        Kependudukan</h2>
                    <div class="flex flex-col gap-3 flex-1 shrink-0">
                        <Input v-model="familyMember.identity_number" type="text" placeholder="Ketik NIK" maxlength="16"
                            :error-message="getFieldError('identity_number')" :icon="IconKeyboardSecondaryGreen"
                            :filled-icon="IconKeyboardBlack" @update:model-value="clearFieldError('identity_number')" />
                    </div>
                </section>
                <hr class="border-desa-background" />
                    ...
                    <div class="flex items-center gap-6 flex-1 shrink-0">
                        <div class="flex flex-col gap-3 w-full">
                            <Input v-model="familyMember.date_of_birth" type="date" placeholder="Pilih tanggal lahir"
                                :error-message="getFieldError('date_of_birth')" :icon="IconCalendar2SecondaryGreen"
                                :filled-icon="IconCalendar2SecondaryGreen" />
                        </div>
                        <div
