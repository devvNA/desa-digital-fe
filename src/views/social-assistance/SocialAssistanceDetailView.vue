    ...
    <div class="flex flex-col gap-4">
        <div id="Header" class="flex items-center justify-between">
            ...
            >
                ...
                <router-link
                    :to="{ name: 'edit-social-assistance', params: { id: route.params.id } }"
        ...
        <div class="flex gap-[14px]">
            ...
            >
                ...
                <div class="flex items-center justify-between gap-4">
                    ...
                    >
                        <img
                            :src="getThumbnail(detail.thumbnail)"
                    ...
                    <div
                        class="badge rounded-full p-3 gap-2 flex min-w-[120px] justify-center shrink-0"
            ...
            >
                ...
                <div id="List-Bansos-Terkahir" class="flex flex-col gap-6">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center gap-1">
                                ...
                                >
                                    <img
                                        :src="
                                            getProfilePicture(recipient.recipient_profile_picture)
                                        "
                                        class="w-full h-full object-cover"
                                        alt="photo"
                    ...
                    <div
                        v-if="!recentRecipients.length && !loading"
