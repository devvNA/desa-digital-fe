...
<template>
  <div class="flex flex-col gap-2">
    <div class="relative">
      <input :placeholder="placeholder" :type="type" :value="modelValue" :maxlength="maxlength"
        ...
        :class="errorMessage
          ? 'border-red-500 focus:ring-[1.5px] focus:ring-red-500'
          : 'focus:ring-[1.5px] focus:ring-desa-dark-green'
          " />
    ...
    <span class="text-left text-desa-red" style="font-size: 12px" v-if="errorMessage">
