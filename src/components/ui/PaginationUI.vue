    ...
    <ul class="flex items-center gap-3">
      <li class="group">
        <a @click="serverOptions().page = meta.current_page - 1"
          ...
          <img src="@/assets/images/icons/arrow-left-dark-green.svg" class="flex size-6 shrink-0 group-hover:hidden"
            alt="icon">
          <img src="@/assets/images/icons/arrow-left-foreshadow.svg" class="hidden size-6 shrink-0 group-hover:flex"
            alt="icon">
        </a>
      </li>
      <li v-for="page in meta.last_page" :key="page" class="group" :class="{ 'active': page === meta.current_page }">
